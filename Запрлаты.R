...
#Подготовка данных
Data <- read_excel("C:/Users/ex633/Downloads/Анонимный зарплатный опрос чата ричерчеров - волна 2 (январь 2024).xlsx")
Data[Data=="NA"] <- NA
...
png("~/ЗП/Зарплаты_академия.png", width = 2500, height = 1280)
Allsalary
dev.off()
